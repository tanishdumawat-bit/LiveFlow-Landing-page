    ...
    <div ref={ref} className="relative z-10 -my-4 px-4 py-6 sm:-my-6 sm:px-6 sm:py-8" aria-hidden="true">
      <motion.div style={reduce ? undefined : { opacity, y }} className="mx-auto max-w-5xl">
        <div className="mb-3 flex items-center justify-center gap-3">
          <motion.div
            className="h-px flex-1 origin-right bg-gradient-to-l from-border to-transparent"
        ...
        <div className="flex items-center gap-3">
          <span className="shrink-0 text-[10px] font-medium tracking-[0.2em] text-muted uppercase">
            {from}
          </span>
          <motion.div
